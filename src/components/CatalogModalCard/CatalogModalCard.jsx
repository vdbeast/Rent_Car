                ...
                <div className={styles.container}>
                    ...
                    <div className={styles.text_container}>
                        ...
                        <div className={styles.desc_wrapper}>
                            <p className={styles.car_desc}>{car.address} | Id:{car.id} | Year:{car.year} | Type:{car.type}</p>
                            <p className={styles.car_desc}>Fuel consumption:{car.fuelConsumption} | Engine size:{car.engineSize}</p>
                        </div>
                            ...
                            <div className={styles.first_desc_wrapper}>
                                <ul className={styles.car_desc_list}>
                                    {car.accessories.map((accessory, id) => (
                                        <li className={styles.car_desc_item} key={id}>{accessory}</li>
                                    ))}
                                </ul>
                                <ul className={styles.car_desc_list}>
                                    {car.functionalities.map((functionality, id) => (
                                        <li className={styles.car_desc_item} key={id}>{functionality}</li>
                                    ))}
                                </ul>
                            </div>
                        </div>
                    ...
                    <button className={styles.rent_btn} onClick={() => window.location.href = 'tel:+380730000000'}>Rental Car</button>
                </div>
            </div>
        </div>
    )
